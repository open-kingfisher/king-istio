...
func GateWays() *gateWays {
	return &gateWays{}
}

func (v *gateWays) Get() func(c *gin.Context) {
...
func (v *gateWays) List() func(c *gin.Context) {
	return func(c *gin.Context) {
...
func (v *gateWays) Delete() func(c *gin.Context) {
	return func(c *gin.Context) {
		r, err := v.newResource(c)
		if err != nil {
			responseData := handle.HandlerResponse(nil, err)
...
func (v *gateWays) Patch() func(c *gin.Context) {
	return func(c *gin.Context) {
		var responseData *common.ResponseData
		r, err := v.newResource(c)
		if err != nil {
...
func (v *gateWays) Update() func(c *gin.Context) {
	return func(c *gin.Context) {
		var responseData *common.ResponseData
		r, err := v.newResource(c)
		if err != nil {
...
func (v *gateWays) Create() func(c *gin.Context) {
	return func(c *gin.Context) {
		var responseData *common.ResponseData
		r, err := v.newResource(c)
		if err != nil {
...
func (v *gateWays) Chart() func(c *gin.Context) {
	return func(c *gin.Context) {
		r, err := v.newResource(c)
		if err != nil {
			responseData := handle.HandlerResponse(nil, err)
...
func (v *gateWays) newResource(c *gin.Context) (*resource.GatewaysResource, error) {
